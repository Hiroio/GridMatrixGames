...
final class AppStorageManager {
  ...
  private enum Keys {
    static let onboarding = "spingrid.hasCompletedOnboarding"
    static let sound = "spingrid.isSoundEnabled"
    static let haptic = "spingrid.isHapticEnabled"
    static let sfxVolume = "spingrid.sfxVolume"
    static let difficulty = "spingrid.selectedGameDifficulty"
  }
